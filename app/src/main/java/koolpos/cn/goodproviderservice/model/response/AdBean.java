...
public class AdBean extends BaseBean implements GreenDaoInsert<AdDao> {
    private static final long serialVersionUID = 4003251971827336220L;
    private int id;
    ...
    @Override
    public void insert(AdDao adDao) {
        Ad entity=Ad.createByBean(this);
        adDao.insertOrReplace(entity);
    }
}
