...
public final class Data {
    ...
    public static final String[] URLS = {
            ...
            BASE + "z77CaIt" + EXT, BASE + "1错误11" + EXT,BASE + "我是错误2" + EXT,
            ...
            BASE + "hESJ65s" + EXT, BASE + "qXUADnY" + EXT, BASE + "S7n25Rg" + EXT,
            BASE + "mVS0DdK" + EXT, BASE + "ygk1aXT" + EXT, BASE + "qXUADnY" + EXT,
            BASE + "pC6AOSf" + EXT, BASE + "dhnoxHj" + EXT, BASE + "MHsJuD1" + EXT,
